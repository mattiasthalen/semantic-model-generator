...
Plans:
- [x] 06-01-PLAN.md -- Watermark generation/detection, atomic file writing, WriteSummary result type (TDD)
- [x] 06-02-PLAN.md -- Folder writer with dev/prod modes, watermark-based preservation, overwrite protection (TDD)
